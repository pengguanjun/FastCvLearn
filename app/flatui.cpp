                             ...
                             const QString &handleColor)
{
    ...
    int handleWidth = sliderHeight;
    int handleRadius = handleWidth / 2;
    int handleOffset = handleRadius / 11;

    QStringList list;
    list.append(QString("QSlider::horizontal{min-height:%1px;}").arg(sliderHeight));
    ...
    list.append(QString("QSlider::handle:horizontal{width:%3px;height:%3px;margin-top:-%4px;margin-bottom:-%4px;border-radius:%5px;"
